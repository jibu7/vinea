...
const APPENDIX_C: Record<IntentLabel, Array<[string, string, string | null]>> = {
  ...
  "Transactions": [
    ...
    ["Accounts Receivable", "Invoice", "P4"],
    ["Accounts Receivable", "Credit note", "P4"],
    ["Accounts Receivable", "Receipt", "P4"],
    ["Accounts Receivable", "Allocate", "P4"],
    ["Accounts Receivable", "Account receivable batches", "P4"],
    ["Accounts Payable", "GRV", "P6"],
    ["Accounts Payable", "Purchase order", "P6"],
    ["Accounts Payable", "Supplier invoice", "P4"],
    ["Accounts Payable", "Return to supplier", "P4"],
    ["Accounts Payable", "Payment", "P4"],
    ["Accounts Payable", "Allocate", "P4"],
    ["Accounts Payable", "Account payable batches", "P4"],
...
describe("the Appendix C navigation contract", () => {
  ...
  it("leaves a P4 tag on the transaction, enquiry and report screens step 6 did not build", () => {
    ...
    const stillTagged = navIntents.flatMap((intent) =>
      intent.items.filter((item) => item.phase === "P4").map((item) => `${intent.label}/${item.label}`),
    );
    expect(stillTagged).toEqual([
      ...
      "Transactions/Account receivable batches",
      "Transactions/Supplier invoice",
      "Transactions/Return to supplier",
      "Transactions/Payment",
      "Transactions/Allocate",
      "Transactions/Account payable batches",
      "Enquiries/Customer enquiry",
      "Enquiries/Supplier enquiry",
      "Reports/Age analysis",
      "Reports/Allocation",
      "Reports/Customer listing",
      "Reports/Statements",
      "Reports/Transaction listing",
      "Reports/Age analysis",
      "Reports/Allocation",
      "Reports/Supplier listing",
      "Reports/Statements",
      "Reports/Transaction listing",
    ]);
  });
