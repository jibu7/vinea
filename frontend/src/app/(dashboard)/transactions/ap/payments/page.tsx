  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Supplier Payment Processing & Allocation</h1>
          <p className="text-muted-foreground">
            Process supplier payments and allocate to invoices
          </p>
        </div>
        <Button>
          ...
          <CardContent>
            <div className="text-center py-12">
              ...
              <p className="mt-2 text-muted-foreground">
                Get started by processing your first supplier payment.
              </p>
